...
(function() {
  ...
  const translations = {
    nl: {
      ...
      about_content: `Hallo, mijn naam is Gabriël. Ik heb een <mark>BSc in Computer Science</mark> en een <mark>MSc in Applied Data Science</mark> behaald aan de Universiteit Utrecht. Ik werk als Data Scientist en AI Consultant bij ICT Nederland, waar ik AI-oplossingen implementeer en strategisch advies geef over AI-architectuur.
...
- Op avontuur gaan: ik houd ervan om nieuwe plaatsen te ontdekken en nieuwe ervaringen op te doen, zowel in mijn eigen omgeving als daarbuiten. Ik ben altijd bereid om uit mijn comfortzone te stappen en nieuwe uitdagingen aan te gaan.`
    ...
    en: {
      ...
      about_content: `Hello, my name is Gabriël. I hold a <mark>BSc in Computer Science</mark> and an <mark>MSc in Applied Data Science</mark> from Utrecht University. I work as a Data Scientist and AI Consultant at ICT Nederland, where I implement AI solutions and provide strategic advice on AI architecture.
